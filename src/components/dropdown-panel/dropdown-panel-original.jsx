...
const DropdownPanelOriginal = ({ label, children }) => {
  ...
  return (
    <div className='gl-dropdown-panel__container' ref={contentRef}>
      <div
        ...
        <span className='gl-dropdown-panel__toggle-icon'>
          { Icons.FILTER }
        </span>
      </div>
      <Animate
...
DropdownPanelOriginal.propTypes = {
  label: PropTypes.string.isRequired,
  children: PropTypes.node.isRequired
};

export default DropdownPanelOriginal;
